...
const Step2_Location = ({ register, setValue, watch, errors }) => {
  ...
  // Register fields for yup validation to work properly
  register("propertyInfo.provinceCode"); 
  register("propertyInfo.districtCode"); 
  register("propertyInfo.propertyWard"); 
  ...
  const handleSelectSuggestion = async (place) => {
    ...
    const { country, province, district, ward } = extractLocationFromMapbox(place);
    setValue("propertyInfo.propertyAddress", place.place_name, { shouldValidate: true });
    setValue("propertyInfo.country", country);
  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-5 space-y-6 order-2 lg:order-1">
            ...
            <div className="space-y-6">
                ...
                <TextField 
                    ...
                    {...register("propertyInfo.propertyAddress")} 
        ...
        {/* ===== CỘT PHẢI: BẢN ĐỒ ===== */}
        <div className="lg:col-span-7 order-1 lg:order-2 h-[500px] lg:h-[600px] relative rounded-3xl overflow-hidden shadow-xl border border-gray-200 group">
